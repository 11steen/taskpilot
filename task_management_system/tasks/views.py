...
from .serializers import ProjectSerializer, TaskSerializer, CommentSerializer, TagSerializer
...
class TaskViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated, IsProjectOwnerOrMember, IsProjectOwner]
    authentication_classes = [JWTAuthentication]
